...
{
    public partial class UserConReNewLicenses : UserControl
    {
        ...
        private void _CheckAbilityToRewNew()
        {
            if (_IsActive == 0)
            {
                btnIssue.Enabled = false;
            ...
            if (_ExpirationDate > DateTime.Now)
            {
                ...
                linkLabelHistory.Enabled = false;
                linkLabelInfo.Enabled = false;
                MessageBox.Show("You Can't Issue New License  Because it not Expiration ?");
                return;
            }
        }
        ...
        private void _FullLabels()
        {
            ...
            lbIssueDate.Text = Date.ToString();
            ...
            lbExpirationDate.Text = Date.AddYears(6).ToString();
        ...
        private void _AddNewLicense()
        {
            ...
            if (_Local != 0)
            {
                ...
                foreach (DataRow row in dataTable.Rows)
                {
                    ...
                    _LicenseID = clsLicenses.AddLicenses(_ApplicationID, _DriverID, _LicenseClassID, _Date, _ExpirationDate, txtNode.Text, 20, 1, 1, _UserID);
                    if (_LicenseID != 0)
                    {
        ...
        private void UserConReNewLicenses_Load(object sender, EventArgs e)
        {
            pictureBox9.Image = Properties.Resources.journalist;
        }
